...
, instructing the AI to only generate the function call when using them. It must also specify an authentic accent and tone.
        ...
        - voiceAccent: Provide a concise description of the accent, gender presentation, and vocal quality the character should maintain (e.g., "a calm, contralto French accent").
