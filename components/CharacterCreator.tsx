...
const CharacterCreator: React.FC<CharacterCreatorProps> = ({ onCharacterCreated, onBack }) => {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      const personaPrompt = `You are the Persona Architect tasked with modelling ${clean}. Match their documented gender presentation, accent, and energy.
...
- voiceAccent (detail accent, gender presentation, tone, and timbre directions that align ${clean}'s background with the chosen voice profile)
