  ...
  const handleCreateCharacter = async () => {
    ...
    try {
      ...
      const prompt = `Based on the historical figure named "${name}" ${focus ? `with a focus on: "${focus}"` : ''}, generate the following details:
        ...
        - voiceAccent: Provide a concise description of the accent, gender presentation, and vocal quality the character should maintain (e.g., "a warm, baritone Italian accent").
