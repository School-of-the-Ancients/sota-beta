  ...
  const handleCreateCharacter = async () => {
    ...
    try {
      ...
      const prompt = `Based on the historical figure named "${name}" ${focus ? `with a focus on: "${focus}"` : ''}, generate the following details:
        ...
        - voiceAccent: Describe the exact accent, vocal tone, and gender presentation the performance must maintain (e.g., "a calm classical Greek baritone with measured pacing").
