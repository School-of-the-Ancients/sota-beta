...
const HistoryView: React.FC<HistoryViewProps> = ({ onBack, history, onDeleteConversation, isLoading }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {sortedHistory.length === 0 ? (
        <p className="text-center text-gray-400 bg-gray-800/50 p-8 rounded-lg">
          {isLoading ? 'Loading your history...' : 'No saved conversations yet.'}
        </p>
      ) : (
