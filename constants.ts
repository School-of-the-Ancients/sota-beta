...
export const AVAILABLE_VOICES: VoiceProfile[] = [
  {
    ...
    accent: 'Contemporary General American with soft academic polish',
    timbre: 'clear mezzo-soprano',
    style: 'encouraging, modern educator',
    description: 'Bright and articulate with approachable warmth, ideal for contemporary scientists and innovators.',
    bestFor: '20th/21st-century female scientists, engineers, reformers',
    keywords: ['american', 'modern', 'scientist', 'female', 'us'],
  },
  {
    name: 'Atlas',
    genderPresentation: 'masculine',
    locale: 'United States',
    accent: 'Neutral General American baritone with grounded cadence',
    timbre: 'resonant baritone',
    style: 'steady, mentor-like coach',
    description: 'Confident, steady American baritone suited to pragmatic builders, inventors, or statesmen.',
    bestFor: 'American founders, modern engineers, pragmatic leaders',
    keywords: ['american', 'male', 'baritone', 'statesman', 'pragmatic'],
  },
  {
    name: 'Aurora',
    genderPresentation: 'feminine',
    locale: 'Canada',
    accent: 'Canadian English with gentle prairie lilt',
    timbre: 'warm mezzo',
    style: 'reassuring, thoughtful guide',
    description: 'Gentle North American delivery with a calming lilt suited to compassionate teachers or reformers.',
    bestFor: 'Social reformers, humanitarians, North American scholars',
    keywords: ['canadian', 'north america', 'female', 'gentle', 'reformer'],
  },
  {
    name: 'Borealis',
    genderPresentation: 'neutral',
    locale: 'Scandinavia',
    accent: 'Soft pan-Scandinavian English with crisp consonants',
    timbre: 'light tenor',
    style: 'calm, observant narrator',
    description: 'Cool and measured Nordic tone, excellent for explorers, scientists, or natural philosophers.',
    bestFor: 'Scandinavian explorers, polar researchers, naturalists',
    keywords: ['scandinavian', 'nordic', 'neutral', 'explorer'],
  },
  {
    name: 'Calliope',
    genderPresentation: 'feminine',
    locale: 'Classical Greece',
    accent: 'Lyric Attic Greek inflection when speaking English',
    timbre: 'lyrical soprano',
    style: 'scholarly storyteller',
    description: 'Melodic and expressive with gentle Greek overtones, perfect for poets, philosophers, and muses.',
    bestFor: 'Ancient Greek poets, philosophers, playwrights',
    keywords: ['greek', 'female', 'classical', 'philosopher', 'poet'],
  },
  {
    name: 'Calypso',
    genderPresentation: 'feminine',
    locale: 'Caribbean',
    accent: 'Caribbean English with melodic cadence',
    timbre: 'rich contralto',
    style: 'captivating storyteller',
    description: 'Expressive Caribbean warmth that shines for storytellers, revolutionaries, or mariners.',
    bestFor: 'Caribbean leaders, storytellers, navigators',
    keywords: ['caribbean', 'female', 'storyteller', 'revolutionary'],
  },
  {
    name: 'Charon',
    genderPresentation: 'masculine',
    locale: 'Classical Greece',
    accent: 'Measured Attic Greek inflection with philosophical gravitas',
    timbre: 'deep baritone',
    style: 'deliberate, contemplative tutor',
    description: 'Deep, thoughtful cadence suited to stoic philosophers, mathematicians, and strategists.',
    bestFor: 'Athenian philosophers, classical generals, stoics',
    keywords: ['greek', 'male', 'philosopher', 'stoic'],
  },
  {
    name: 'Eos',
    genderPresentation: 'feminine',
    locale: 'Eastern Mediterranean',
    accent: 'Mediterranean English with gentle Aegean brightness',
    timbre: 'bright soprano',
    style: 'inspiring visionary',
    description: 'Sunlit tone with Mediterranean sparkle suited to queens, astronomers, or mystics.',
    bestFor: 'Hellenistic queens, astronomers, seers',
    keywords: ['mediterranean', 'female', 'queen', 'astronomer'],
  },
  {
    name: 'Fenrir',
    genderPresentation: 'masculine',
    locale: 'Italy',
    accent: 'Resonant Tuscan Italian inflection with passionate emphasis',
    timbre: 'dramatic tenor',
    style: 'fiery, revolutionary orator',
    description: 'Charged Italian delivery that excels for inventors, revolutionaries, and Renaissance masters.',
    bestFor: 'Italian scientists, revolutionaries, Renaissance figures',
    keywords: ['italian', 'male', 'renaissance', 'revolutionary'],
  },
  {
    name: 'Gaia',
    genderPresentation: 'feminine',
    locale: 'Mediterranean',
    accent: 'Mediterranean English with earthy resonance',
    timbre: 'rounded alto',
    style: 'nurturing, wise elder',
    description: 'Grounded warmth perfect for philosophers, healers, and maternal leaders.',
    bestFor: 'Philosophers, healers, maternal rulers',
    keywords: ['mediterranean', 'female', 'healer', 'wise'],
  },
  {
    name: 'Helios',
    genderPresentation: 'masculine',
    locale: 'Greece',
    accent: 'Classical Greek-inflected English with oratorical brightness',
    timbre: 'ringing tenor',
    style: 'radiant, persuasive rhetorician',
    description: 'Radiant presence for charismatic philosophers, rhetoricians, or champions.',
    bestFor: 'Orators, champions, inspirational leaders',
    keywords: ['greek', 'male', 'orator', 'leader'],
  },
  {
    name: 'Isolde',
    genderPresentation: 'feminine',
    locale: 'Central Europe',
    accent: 'High German English with precise diction',
    timbre: 'resonant mezzo-soprano',
    style: 'precise, analytical lecturer',
    description: 'Disciplined and exacting tone well-suited to mathematicians, composers, or scientists.',
    bestFor: 'German mathematicians, composers, Enlightenment scholars',
    keywords: ['german', 'female', 'mathematician', 'composer'],
  },
  {
    name: 'Juno',
    genderPresentation: 'feminine',
    locale: 'Ancient Rome',
    accent: 'Classical Latin cadence when speaking English',
    timbre: 'commanding contralto',
    style: 'regal, authoritative matriarch',
    description: 'Commanding Roman authority suited to empresses, stateswomen, and jurists.',
    bestFor: 'Roman empresses, jurists, republican leaders',
    keywords: ['roman', 'female', 'empress', 'stateswoman'],
  },
  {
    name: 'Kore',
    genderPresentation: 'feminine',
    locale: 'Victorian Britain',
    accent: 'Upper-class Victorian British English',
    timbre: 'cultured soprano',
    style: 'elegant, precise educator',
    description: 'Poised Victorian clarity perfect for mathematicians, inventors, and aristocratic mentors.',
    bestFor: 'Victorian scientists, British nobility, inventors',
    keywords: ['victorian', 'british', 'female', 'aristocrat'],
  },
  {
    name: 'Lyric',
    genderPresentation: 'neutral',
    locale: 'United States',
    accent: 'Soft contemporary American with youthful energy',
    timbre: 'light alto-tenor mix',
    style: 'curious, collaborative peer',
    description: 'Youthful and curious tone suitable for prodigies, students, or creative collaborators.',
    bestFor: 'Prodigies, creative collaborators, young innovators',
    keywords: ['youthful', 'modern', 'neutral', 'creative'],
  },
  {
    name: 'Mistral',
    genderPresentation: 'neutral',
    locale: 'France',
    accent: 'Parisian French-accented English with smooth delivery',
    timbre: 'silky tenor',
    style: 'intellectual, composed guide',
    description: 'Effortless French elegance ideal for philosophers, artists, and diplomats.',
    bestFor: 'French philosophers, impressionists, diplomats',
    keywords: ['french', 'paris', 'neutral', 'artist'],
  },
  {
    name: 'Nautilus',
    genderPresentation: 'masculine',
    locale: 'United Kingdom',
    accent: 'Received Pronunciation with nautical gravitas',
    timbre: 'stately baritone',
    style: 'measured, strategic commander',
    description: 'Measured British authority perfect for admirals, strategists, and inventors.',
    bestFor: 'British naval officers, strategists, industrialists',
    keywords: ['british', 'rp', 'male', 'naval', 'strategist'],
  },
  {
    name: 'Nova',
    genderPresentation: 'feminine',
    locale: 'United States (West Coast)',
    accent: 'West Coast American English with inventive sparkle',
    timbre: 'bright mezzo',
    style: 'imaginative, forward-looking coach',
    description: 'Vibrant and forward-looking, excellent for futurists, technologists, and artists.',
    bestFor: 'Futurists, Silicon Valley innovators, modern artists',
    keywords: ['american', 'west coast', 'innovator', 'female'],
  },
  {
    name: 'Orion',
    genderPresentation: 'masculine',
    locale: 'United Kingdom',
    accent: 'Contemporary British with classical polish',
    timbre: 'refined tenor',
    style: 'dignified, scholarly instructor',
    description: 'Scholarly British tone suited to astronomers, explorers, and philosophers.',
    bestFor: 'Astronomers, explorers, Oxbridge scholars',
    keywords: ['british', 'male', 'scholar', 'astronomer'],
  },
  {
    name: 'Puck',
    genderPresentation: 'masculine',
    locale: 'Northern Europe',
    accent: 'Northern European English with playful undercurrent',
    timbre: 'sprightly baritone',
    style: 'clever, encouraging sage',
    description: 'Lively yet grounded tone perfect for polymaths, inventors, and curious mentors.',
    bestFor: 'Inventors, alchemists, whimsical polymaths',
    keywords: ['northern europe', 'male', 'inventor', 'mentor'],
  },
  {
    name: 'Rhea',
    genderPresentation: 'feminine',
    locale: 'Greece',
    accent: 'Soft Greek-English with nurturing cadence',
    timbre: 'velvety alto',
    style: 'gentle, reflective counselor',
    description: 'Nurturing Greek warmth fit for philosophers, healers, and stoic teachers.',
    bestFor: 'Greek philosophers, healers, spiritual guides',
    keywords: ['greek', 'female', 'healer', 'counselor'],
  },
  {
    name: 'Saffron',
    genderPresentation: 'feminine',
    locale: 'South Asia',
    accent: 'Indian English with Kolkata-Delhi blend',
    timbre: 'expressive mezzo',
    style: 'insightful, eloquent mentor',
    description: 'Eloquent South Asian tone ideal for mathematicians, poets, and freedom fighters.',
    bestFor: 'Indian mathematicians, reformers, poets',
    keywords: ['indian', 'female', 'south asia', 'reformer'],
  },
  {
    name: 'Selene',
    genderPresentation: 'feminine',
    locale: 'Aegean',
    accent: 'Aegean Greek-inflected English with serene pace',
    timbre: 'serene mezzo',
    style: 'calm, contemplative mystic',
    description: 'Serene Aegean glow made for astronomers, philosophers, or spiritual guides.',
    bestFor: 'Mystics, astronomers, contemplative philosophers',
    keywords: ['aegean', 'female', 'mystic', 'astronomer'],
  },
  {
    name: 'Sol',
    genderPresentation: 'neutral',
    locale: 'Spain',
    accent: 'Castilian Spanish-accented English with warm resonance',
    timbre: 'golden tenor',
    style: 'radiant, hospitable teacher',
    description: 'Warm Iberian brightness suited to explorers, painters, and diplomats.',
    bestFor: 'Spanish explorers, painters, diplomats',
    keywords: ['spanish', 'iberian', 'neutral', 'explorer'],
  },
  {
    name: 'Thalia',
    genderPresentation: 'feminine',
    locale: 'Ancient Greece',
    accent: 'Musical Hellenic inflection with storyteller cadence',
    timbre: 'expressive soprano',
    style: 'enthusiastic, Socratic muse',
    description: 'Animated Greek energy suited to dramatists, philosophers, and rhetoricians.',
    bestFor: 'Greek dramatists, rhetoricians, muses',
    keywords: ['greek', 'female', 'dramatist', 'rhetoric'],
  },
  {
    name: 'Valkyrie',
    genderPresentation: 'feminine',
    locale: 'Nordic Europe',
    accent: 'Nordic English with commanding resonance',
    timbre: 'heroic mezzo',
    style: 'bold, inspiring shieldmaiden',
    description: 'Heroic Nordic power perfect for warriors, leaders, and explorers.',
    bestFor: 'Viking explorers, Nordic rulers, military leaders',
    keywords: ['nordic', 'female', 'warrior', 'leader'],
  },
  {
    name: 'Zephyr',
    genderPresentation: 'feminine',
    locale: 'Hellenistic Mediterranean',
    accent: 'Elegant Mediterranean English with gentle Greek lyricism',
    timbre: 'airy mezzo-soprano',
    style: 'regal, serene counselor',
    description: 'Graceful and queenly, perfect for Hellenistic rulers, philosophers, or diplomats.',
    bestFor: 'Queens, diplomats, Hellenistic philosophers',
    keywords: ['greek', 'female', 'queen', 'diplomat'],
  },
  {
    name: 'Zenith',
    genderPresentation: 'neutral',
    locale: 'East Asia',
    accent: 'Light East Asian English with refined cadence',
    timbre: 'balanced alto-tenor',
    style: 'focused, contemplative sage',
    description: 'Balanced and tranquil voice suited to scholars, strategists, and inventors across East Asia.',
    bestFor: 'East Asian scholars, strategists, polymaths',
    keywords: ['east asia', 'neutral', 'scholar', 'strategist'],
  },
  {
    name: 'Sable',
    genderPresentation: 'feminine',
    locale: 'West Africa',
    accent: 'West African English with lyrical cadence',
    timbre: 'soulful contralto',
    style: 'wise, resonant storyteller',
    description: 'Soulful West African resonance perfect for historians, griots, and activists.',
    bestFor: 'West African historians, activists, cultural leaders',
    keywords: ['west africa', 'female', 'storyteller', 'activist'],
  },
  {
    name: 'Seeker',
    genderPresentation: 'neutral',
    locale: 'Middle East',
    accent: 'Levantine English with thoughtful poise',
    timbre: 'calm alto-tenor',
    style: 'curious, meditative scholar',
    description: 'Thoughtful Levantine cadence ideal for polymaths, astronomers, and philosophers.',
    bestFor: 'Middle Eastern polymaths, astronomers, philosophers',
    keywords: ['levant', 'middle east', 'scholar', 'neutral'],
  },
];

export const AVAILABLE_VOICE_NAMES = AVAILABLE_VOICES.map(v => v.name);

export const VOICE_CATALOG_PROMPT = AVAILABLE_VOICES.map(
  voice =>
    `${voice.name} — ${voice.description} Accent: ${voice.accent}. Timbre: ${voice.timbre}. Gender presentation: ${voice.genderPresentation}. Best for: ${voice.bestFor}.`
).join('\n');
