...
export const AVAILABLE_VOICES: VoiceProfile[] = [
  {
    name: 'Aletheia',
    gender: 'female',
    accent: 'neutral Mediterranean English',
    style: 'measured, scholarly, subtly empathetic',
    description: 'HD female voice with warm Mediterranean English lilt, ideal for philosophers and humanists.',
  },
  {
    name: 'Aster',
    gender: 'female',
    accent: 'North American',
    style: 'bright, encouraging, contemporary',
    description: 'HD female voice with a clear North American tone suited for visionary scientists and inventors.',
  },
  {
    name: 'Atlas',
    gender: 'male',
    accent: 'neutral North American baritone',
    style: 'steady, authoritative, mentor-like',
    description: 'HD male voice with deep resonance that fits strategists, generals, and stoic leaders.',
  },
  {
    name: 'Calliope',
    gender: 'female',
    accent: 'classic Received Pronunciation',
    style: 'lyrical, eloquent, theatrical',
    description: 'HD female voice with polished RP delivery suited to poets, dramatists, and rhetoricians.',
  },
  {
    name: 'Celestine',
    gender: 'female',
    accent: 'light French-inflected English',
    style: 'romantic, expressive, melodic',
    description: 'HD female voice with Franco-English grace ideal for artists, composers, and visionaries.',
  },
  {
    name: 'Charon',
    gender: 'male',
    accent: 'formal British baritone',
    style: 'measured, stately, professorial',
    description: 'HD male voice with dignified RP gravitas for scholars, monarchs, and mathematicians.',
  },
  {
    name: 'Ember',
    gender: 'female',
    accent: 'Australian English',
    style: 'spirited, confident, modern',
    description: 'HD female voice with crisp Australian cadence suited to innovators and explorers.',
  },
  {
    name: 'Fenrir',
    gender: 'male',
    accent: 'dramatic Italian',
    style: 'fiery, bold, rhetorical',
    description: 'HD male voice with passionate Italian resonance for revolutionaries and scientists.',
  },
  {
    name: 'Gaia',
    gender: 'female',
    accent: 'Mediterranean English',
    style: 'nurturing, contemplative, grounded',
    description: 'HD female voice with earthy Mediterranean warmth, ideal for naturalists and healers.',
  },
  {
    name: 'Halcyon',
    gender: 'nonbinary',
    accent: 'light Pacific Northwest English',
    style: 'calming, patient, meditative',
    description: 'HD nonbinary voice with serene Pacific Northwest tone for mindfulness and philosophy mentors.',
  },
  {
    name: 'Helios',
    gender: 'male',
    accent: 'Greek-inflected English tenor',
    style: 'radiant, persuasive, energetic',
    description: 'HD male voice with bright Hellenic edge suited to polymaths and charismatic teachers.',
  },
  {
    name: 'Iris',
    gender: 'female',
    accent: 'soft Irish English',
    style: 'lyrical, empathic, storytelling',
    description: 'HD female voice with musical Irish lilt ideal for poets, dramatists, and caretakers.',
  },
  {
    name: 'Juniper',
    gender: 'female',
    accent: 'Pacific coast North American',
    style: 'curious, upbeat, conversational',
    description: 'HD female voice with youthful West Coast energy for inventors and experimenters.',
  },
  {
    name: 'Kore',
    gender: 'female',
    accent: 'upper-class 19th-century British',
    style: 'precise, poised, insightful',
    description: 'HD female voice with patrician Victorian British diction ideal for mathematicians and nobles.',
  },
  {
    name: 'Lumen',
    gender: 'nonbinary',
    accent: 'neutral global English',
    style: 'crisp, analytical, modern',
    description: 'HD nonbinary voice with balanced global accent for scientists, engineers, and analysts.',
  },
  {
    name: 'Lyra',
    gender: 'female',
    accent: 'Mediterranean Spanish-English',
    style: 'musical, warm, inviting',
    description: 'HD female voice with lyrical Mediterranean cadence suited to artists and astronomers.',
  },
  {
    name: 'Magnus',
    gender: 'male',
    accent: 'Nordic English',
    style: 'stoic, deliberate, resonant',
    description: 'HD male voice with Nordic authority perfect for explorers, generals, and reformers.',
  },
  {
    name: 'Meridian',
    gender: 'nonbinary',
    accent: 'transatlantic English',
    style: 'measured, guiding, inspirational',
    description: 'HD nonbinary voice with classic transatlantic polish suited for statespersons and lecturers.',
  },
  {
    name: 'Mira',
    gender: 'female',
    accent: 'Middle Eastern English',
    style: 'warm, articulate, reflective',
    description: 'HD female voice with gentle Levantine tones for scholars, physicians, and poets.',
  },
  {
    name: 'Orion',
    gender: 'male',
    accent: 'neutral global English',
    style: 'curious, exploratory, confident',
    description: 'HD male voice with balanced global delivery for explorers, scientists, and navigators.',
  },
  {
    name: 'Peregrine',
    gender: 'male',
    accent: 'refined British RP',
    style: 'adventurous, witty, scholarly',
    description: 'HD male voice with adventurous RP timbre suited to natural philosophers and diplomats.',
  },
  {
    name: 'Puck',
    gender: 'male',
    accent: 'light British Isles mix',
    style: 'playful, agile, quick-thinking',
    description: 'HD male voice with sprightly British Isles cadence perfect for polymaths and tacticians.',
  },
  {
    name: 'Selene',
    gender: 'female',
    accent: 'classical Greek-English',
    style: 'serene, wise, celestial',
    description: 'HD female voice with moonlit Greek cadence for philosophers and astronomers.',
  },
  {
    name: 'Sol',
    gender: 'male',
    accent: 'Castilian Spanish-English',
    style: 'warm, charismatic, expansive',
    description: 'HD male voice with radiant Spanish inflection suited to explorers and artists.',
  },
  {
    name: 'Sora',
    gender: 'female',
    accent: 'Japanese English',
    style: 'precise, thoughtful, gentle',
    description: 'HD female voice with clear Japanese-English articulation ideal for inventors and strategists.',
  },
  {
    name: 'Thalia',
    gender: 'female',
    accent: 'southern European English',
    style: 'cheerful, persuasive, theatrical',
    description: 'HD female voice with expressive southern European color perfect for rhetoricians and dramatists.',
  },
  {
    name: 'Titan',
    gender: 'male',
    accent: 'low resonant North American',
    style: 'commanding, disciplined, heroic',
    description: 'HD male voice with commanding low timbre suited to generals and reformers.',
  },
  {
    name: 'Verdant',
    gender: 'nonbinary',
    accent: 'gentle British Isles',
    style: 'soothing, patient, contemplative',
    description: 'HD nonbinary voice with calm British Isles cadence ideal for naturalists and healers.',
  },
  {
    name: 'Vesper',
    gender: 'female',
    accent: 'low mezzo European',
    style: 'mature, reflective, cinematic',
    description: 'HD female voice with cinematic European depth suited to strategists and historians.',
  },
  {
    name: 'Zephyr',
    gender: 'male',
    accent: 'light transatlantic',
    style: 'breezy, optimistic, urbane',
    description: 'HD male voice with breezy transatlantic charm perfect for polymaths and explorers.',
  },
];

export const AVAILABLE_VOICE_NAMES = AVAILABLE_VOICES.map(voice => voice.name);
